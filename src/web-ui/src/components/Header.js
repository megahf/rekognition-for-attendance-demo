...
const Header = ({ readyToStream, signedIn, toggleRekognition, attendanceState, showAttendanceList, disableAttendanceList }) => {
            ...
            {userEmail && (
              <>
                <RekognitionButton
                  ...
                  enabled={readyToStream && !attendanceState}
                />

                <Button onClick={disableAttendanceList} variant="warning" size="sm"> 
                  Camera
                </Button>

                <Button onClick={showAttendanceList} variant="warning" size="sm">
                  Attendance List
                </Button>
